...
Q_CONSTINIT static const uint qt_meta_data_CLASSAnalysisDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AnalysisDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSAnalysisDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAnalysisDialogENDCLASS,
    qt_static_metacall,
    nullptr,
...
void *AnalysisDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAnalysisDialogENDCLASS.stringdata0))
